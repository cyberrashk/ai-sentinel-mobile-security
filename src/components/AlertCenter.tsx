    ...
    const sampleAlerts: SecurityAlert[] = [
      {
        ...
        resolved: false,
        actionRequired: true,
        details: { path: 'C:\\Users\\User\\Downloads\\installer.exe', quarantined: false }
      },
      {
        id: '2',
        type: 'breach',
        ...
        resolved: false,
        actionRequired: true,
        details: { email: authService.getCurrentUser()?.email, source: 'LinkedIn', dataExposed: ['email', 'password', 'name'] }
      },
      {
        id: '3',
        type: 'scan',
        ...
        details: { itemsScanned: 15000, duration: '5m 32s' }
      }
    ];
      ...
      sampleAlerts.push(
        {
          ...
          resolved: false,
          actionRequired: true,
          details: { device: 'iPad-Kids', website: 'gambling-site.com', blocked: true }
        },
        {
          id: '5',
          type: 'financial',
          ...
          resolved: false,
          actionRequired: true,
          details: { bank: 'Chase Bank', location: 'Unknown IP - Russia', blocked: true }
        },
        {
          id: '6',
          type: 'chat',
          ...
          resolved: true,
          actionRequired: false,
          details: { contact: 'john.doe@company.com', encryption: 'AES-256' }
        }
      );
    }
